...
if chooseport; then
cp -f $MODPATH/system/fonts/McMejiro-Bold.ttf $MODPATH/system/fonts/McMejiro-Extrabold.ttf
cp -f $MODPATH/system/fonts/McMejiro-Light.ttf $MODPATH/system/fonts/McMejiro-Thin.ttf
ui_print "Disabled."
ui_print "無効化しました。"
fi
